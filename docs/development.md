...
|RF-02| O sistema deve permitir que educadores criem turmas, adicionem alunos e vinculem perfis de aprendizagem ao contato docente. | Leticia | rf-painel.hetml |
...
|RF-07| O sistema deve oferecer um "Cofre Mágico" virtual onde o usuário deposita moedas e visualiza o progresso da meta de poupança. | Henrique | rf07-cofre-magico.html |
...
|RF-09| O sistema deve rastrear e categorizar automaticamente “gastos formigas” (pequenas despesas recorrentes como cafés e transporte). | Henrique | rf09-gastos-formiga.html |
|RF-10| O sistema deve permitir o registro manual de ganhos e despesas, com suporte a categorias personalizadas e metas de reserva de emergência. | Leticia | rf-financeiros.html |
