...
const CONTEUDOS = {
  crianca: {
    ...
    cards: [
      ...
      },
      {
        ...
        href: 'ranking.html', cta: 'Ver conquistas',
      },
      {
        icon: 'fa-route', cor: '#1abc9c',
        title: 'Trilhas de Aventura',
        desc: 'Lições divertidas e curtinhas para aprender a cuidar do dinheiro.',
        href: 'trilhas.html', cta: 'Começar a aprender',
      },
      {
  ...
  adolescente: {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: 'Missões sobre orçamento, crédito, consumo e investimentos.',
        href: 'trilhas.html', cta: 'Ver trilhas',
      },
      {
        icon: 'fa-trophy', cor: '#f1c40f',
        title: 'Ranking & Conquistas',
        desc: 'Veja seu nível, suas conquistas e sua posição no ranking.',
        href: 'ranking.html', cta: 'Ver ranking',
      },
    ],
  },
  ...
  jovemAdulto: {
    ...
    cards: [
      ...
      {
        icon: 'fa-chart-pie', cor: '#e67e22',
        title: 'Relatórios Financeiros',
        desc: 'Gráficos de entradas, saídas, categorias e progresso de metas.',
        href: 'relatórios.html', cta: 'Ver relatórios',
      },
      {
        icon: 'fa-route', cor: '#1abc9c',
        title: 'Trilhas de Aprendizado',
        desc: 'Orçamento, poupança, crédito, consumo consciente e investimentos.',
        href: 'trilhas.html', cta: 'Acessar trilhas',
      },
      {
        icon: 'fa-trophy', cor: '#34495e',
        title: 'Ranking & Conquistas',
        desc: 'Acompanhe seu nível, conquistas e desafios progressivos.',
        href: 'ranking.html', cta: 'Ver ranking',
      },
    ],
  },
  ...
  autonomo: {
    ...
    cards: [
      ...
      },
      {
        ...
        href: 'relatórios.html', cta: 'Ver relatório',
      },
      {
      ...
      {
        icon: 'fa-route', cor: '#16a085',
        title: 'Trilhas de Aprendizado',
        desc: 'Aprofunde-se em orçamento, reserva, crédito e investimentos.',
        href: 'trilhas.html', cta: 'Acessar trilhas',
      },
    ],
  },
  ...
  educador: {
    ...
    cards: [
      ...
      {
        icon: 'fa-route', cor: '#27ae60',
        title: 'Trilhas de Aprendizado',
        desc: 'Conheça as trilhas que os alunos percorrem e use-as como recurso pedagógico.',
        href: 'trilhas.html', cta: 'Ver trilhas',
      },
    ],
  },
